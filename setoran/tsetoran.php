<html>
 ...
 <table class="data">
	 ...
	 <?php 
		 include "../koneksi.php";
		 $query = mysql_query("select * from setoran");
		 $no = 0;
	 ...
	 <tr class="data">
		 ...
		 <td class="data"><?php echo "$data[tglsetoran]"; ?></td>
		 <td class="data"><?php echo "$data[jumlah]"; ?></td>
		 <td class="data"><a href=hapussetoran.php?nosetoran=<?php echo "$data[nosetoran]";?> 
		 onclick="if (!confirm('Anda yakin akan menghapus?')) return false;">
		 hapus</a></td>
		 <td class="data"><a href=editsetoran.php?nosetoran=<?php echo "$data[nosetoran]";?>>edit</a></td>
	 </tr>
	 <?php } ?>
 </table>
 <a href="inputsetoran.php">input</a>
	 </div>
 <div class="clear"></div>
 <div id="footer">
