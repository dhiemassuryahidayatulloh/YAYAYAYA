...
<?php
	...
	$hapus = "delete from setoran where nosetoran='$nosetoran'";
	$hasil = mysql_query($hapus);
	if ($hasil){
		echo "Data berhasil dihapus, <a href=tsetoran.php>kembali</a>";
	}else{
		echo "Data gagal dihapus, <a href=tsetoran.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
