...
<div id="wrapper">
	...
	$jumlah = $_POST['jumlah'];
	$edit = "update setoran set jumlah='$jumlah', tglsetoran='$tglsetoran' where nosetoran='$nosetoran'";
	$hasil = mysql_query($edit);
	if($hasil){
		echo "Data berhasil diedit, <a href=tsetoran.php>kembali</a>";
	} else {
		echo "Data gagal diedit. <a href=editsetoran.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
