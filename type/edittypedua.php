...
<div id="wrapper">
	...
	$edit = "update type set kodemerk='$kodemerk', nmtype='$nmtype' where idtype='$idtype'";
	$hasil = mysql_query($edit);
	if($hasil){
		echo "Data berhasil diedit, <a href=ttype.php>kembali</a>";
	} else {
		echo "Data gagal diedit. <a href=edittype.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
