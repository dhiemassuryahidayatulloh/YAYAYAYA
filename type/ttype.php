<html>
 ...
 <table class="data">
	 ...
	 <tr class="data">
		 ...
		 <td class="data"><?php echo "$data[nmtype]"; ?></td>
		 <td class="data"><?php echo "$data[kodemerk]"; ?></td>
		 <td class="data"><a href=hapustype.php?idtype=<?php echo "$data[idtype]";?> 
		 onclick="if (!confirm('Anda yakin akan menghapus?')) return false;">
		 hapus</a></td>
		 <td class="data"><a href=edittype.php?idtype=<?php echo "$data[idtype]";?>>edit</a></td>
	 </tr>
	 <?php } ?>
 </table>
 <a href="inputtype.php">input</a>
	 </div>
 <div class="clear"></div>
 <div id="footer">
