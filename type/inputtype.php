...
<div id="wrapper">
	...
	<div id="rightContent">
	<h3>Input type</h3>
	<form action="inputtype.php" method="post">
	<table width="95%">
		<tr><td width="125px"><b>idtype</b></td><td><input type="text" name="idtype" class="pendek"></td></tr>
		<tr><td width="125px"><b>nmtype</b></td><td><input type="text" name="nmtype" class="sedang"></td></tr>
		<tr><td width="125px"><b>kodemerk</b></td><td><input type="text" name="kodemerk" class="panjang"></td></tr>
	</table>
	...
	$cek_idtype = mysql_num_rows(mysql_query("select * from type where idtype='$idtype'"));
		
	if((empty($idtype)) || (empty($nmtype)) ||  (empty($kodemerk))){
		echo "Maaf, data tidak boleh kosong.";
	} elseif ($cek_idtype > 0){
		echo "idtype tidak boleh ada yang sama.";
	} else {
		$input = "insert into type values('$idtype','$nmtype','$kodemerk')";
		mysql_query($input);
		if ($input){
			echo "Data berhasil disimpan. <a href=ttype.php>kembali</a>";
		} else {
