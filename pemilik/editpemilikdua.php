...
<div id="wrapper">
	...
	$edit = "update pemilik set nosetoran='$nosetoran', telppemilik='$telppemilik', nmpemilik='$nmpemilik', almtpemilik='$almtpemilik'  where kodepemilik='$kodepemilik'";
	$hasil = mysql_query($edit);
	if($hasil){
		echo "Data berhasil diedit, <a href=tpemilik.php>kembali</a>";
	} else {
		echo "Data gagal diedit. <a href=editpemilik.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
