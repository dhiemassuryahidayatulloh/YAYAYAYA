...
<?php
	...
	$hapus = "delete from pemilik where kodepemilik='$kodepemilik'";
	$hasil = mysql_query($hapus);
	if ($hasil){
		echo "Data berhasil dihapus, <a href=tpemilik.php>kembali</a>";
	}else{
		echo "Data gagal dihapus, <a href=tpemilik.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
