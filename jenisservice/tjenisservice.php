 ...
 <div id="wrapper">
	 ...
	 <div id="rightContent">
	 <h3>Tampil jenisservice</h3>
 <table class="data">
	 <tr>
		<th>no</th>
		<th>idjenisservice</th>
		<th>nmjenisservice</th>
		<th colspan="2">Aksi</th>
	 </tr>
	 <?php 
		 include "../koneksi.php";
		 $query = mysql_query("select * from jenisservice");
		 $no = 0;
	 ...
	 <tr class="data">
		 ...
		 <td class="data"><?php echo "$data[idjenisservice]"; ?></td>
		 <td class="data"><?php echo "$data[nmjenisservice]"; ?></td>
		 <td class="data"><a href=hapusjenisservice.php?idjenisservice=<?php echo "$data[idjenisservice]";?> 
		 onclick="if (!confirm('Anda yakin akan menghapus?')) return false;">
		 hapus</a></td>
		 <td class="data"><a href=editjenisservice.php?idjenisservice=<?php echo "$data[idjenisservice]";?>>edit</a></td>
	 </tr>
	 <?php } ?>
 </table>
 <a href="inputjenisservice.php">input</a>
	 </div>
 <div class="clear"></div>
 <div id="footer">
