...
<div id="wrapper">
	...
	$edit = "update jenisservice set nmjenisservice='$nmjenisservice' where idjenisservice='$idjenisservice' ";
	$hasil = mysql_query($edit);
	if($hasil){
		echo "Data berhasil diedit, <a href=tjenisservice.php>kembali</a>";
	} else {
		echo "Data gagal diedit. <a href=editjenisservice.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
