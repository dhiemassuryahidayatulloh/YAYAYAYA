<html>
 ...
 <div id="wrapper">
	 ...
	 <div id="rightContent">
	 <h3>Tampil transaksisewa</h3>
 <table class="data">
	 <tr>
		<th>no</th>
		<th>notransaksi</th>
		<th>tglpinjam</th>
		<th>tglkembalirencana</th>
		<th>kondisimobilpinjam</th>
		<th>kondisimobilkembali</th>
		<th>nik</th>
		<th>noktp</th>
		<th>idsopir</th>
		<th>noplat</th>
	 ...
	 <tr class="data">
		 ...
		 <td class="data"><?php echo "$data[notransaksi]"; ?></td>
		 <td class="data"><?php echo "$data[tglpinjam]"; ?></td>
		 <td class="data"><?php echo "$data[tglkembalirencana]"; ?></td>
		 <td class="data"><?php echo "$data[kondisimobilpinjam]"; ?></td>
		 <td class="data"><?php echo "$data[kondisimobilkembali]"; ?></td>
		 <td class="data"><?php echo "$data[nik]"; ?></td>
		 <td class="data"><?php echo "$data[noktp]"; ?></td>
		 <td class="data"><?php echo "$data[idsopir]"; ?></td>
		 <td class="data"><?php echo "$data[noplat]"; ?></td>
		 <td class="data"><a href=hapustransaksisewa.php?notransaksi=<?php echo "$data[notransaksi]";?> 
		 onclick="if (!confirm('Anda yakin akan menghapus?')) return false;">
		 hapus</a></td>
		 <td class="data"><a href=edittransaksisewa.php?notransaksi=<?php echo "$data[notransaksi]";?>>edit</a></td>
	 </tr>
	 <?php } ?>
 </table>
 <a href="inputtransaksisewa.php">input</a>
	 </div>
 <div class="clear"></div>
 <div id="footer">
