...
<div id="wrapper">
	...
	$noplat = $_POST['noplat'];
	$edit = "update transaksisewa set noplat='$noplat', idsopir='$idsopir', noktp='$noktp', nik='$nik', kondisimobilkembali='$kondisimobilkembali', kondisimobilpinjam='$kondisimobilpinjam' , tglkembalirencana='$tglkembalirencana', tglpinjam='$tglpinjam' where notransaksi='$notransaksi'";
	$hasil = mysql_query($edit);
	if($hasil){
		echo "Data berhasil diedit, <a href=ttransaksisewa.php>kembali</a>";
	} else {
		echo "Data gagal diedit. <a href=edittransaksisewa.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
