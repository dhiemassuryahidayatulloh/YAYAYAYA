...
<div id="wrapper">
	...
	<div id="rightContent">
	<h3>Hapus transaksisewa</h3>
<?php
	include "../koneksi.php";
	$notransaksi = $_GET['notransaksi'];
	$hapus = "delete from transaksisewa where notransaksi='$notransaksi'";
	$hasil = mysql_query($hapus);
	if ($hasil){
		echo "Data berhasil dihapus, <a href=ttransaksisewa.php>kembali</a>";
	}else{
		echo "Data gagal dihapus, <a href=ttransaksisewa.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
