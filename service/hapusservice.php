...
<?php
	...
	$hapus = "delete from service where kodeservice='$kodeservice'";
	$hasil = mysql_query($hapus);
	if ($hasil){
		echo "Data berhasil dihapus, <a href=tservice.php>kembali</a>";
	}else{
		echo "Data gagal dihapus, <a href=tservice.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
