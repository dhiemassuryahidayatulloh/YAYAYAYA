<html>
 ...
 <table class="data">
	 ...
	 <tr class="data">
		 ...
		 <td class="data"><?php echo "$data[tglservice]"; ?></td>
		 <td class="data"><?php echo "$data[biayaservice]"; ?></td>
		 <td class="data"><?php echo "$data[idjenisservice]"; ?></td>
		 <td class="data"><a href=hapusservice.php?kodeservice=<?php echo "$data[kodeservice]";?> 
		 onclick="if (!confirm('Anda yakin akan menghapus?')) return false;">
		 hapus</a></td>
		 <td class="data"><a href=editservice.php?kodeservice=<?php echo "$data[kodeservice]";?>>edit</a></td>
	 </tr>
	 <?php } ?>
 </table>
 <a href="inputservice.php">input</a>
	 </div>
 <div class="clear"></div>
 <div id="footer">
