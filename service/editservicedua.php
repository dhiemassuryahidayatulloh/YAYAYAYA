...
<div id="wrapper">
	...
	$edit = "update service set idjenisservice='$idjenisservice', biayaservice='$biayaservice', tglservice='$tglservice' where kodeservice='$kodeservice'";
	$hasil = mysql_query($edit);
	if($hasil){
		echo "Data berhasil diedit, <a href=tservice.php>kembali</a>";
	} else {
		echo "Data gagal diedit. <a href=editservice.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
