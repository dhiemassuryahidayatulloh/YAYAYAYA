...
<div id="wrapper">
	...
	<table width="95%">
		<tr><td width="125px"><b>noktp</b></td><td><input type="text" name="noktp" class="pendek"></td></tr>
		<tr><td width="125px"><b>namapel</b></td><td><input type="text" name="namapel" class="sedang"></td></tr>
		<tr><td width="125px"><b>alamatpel</b></td><td><input type="text" name="alamatpel" class="panjang"></td></tr>
		<tr><td width="125px"><b>telppel</b></td><td> <input type="text" name="telppel" class="sedang"></td></tr>
	</table>
	...
	$cek_nik = mysql_num_rows(mysql_query("select * from pelanggan where noktp='$noktp'"));
		
	if((empty($noktp)) || (empty($namapel)) || (empty($alamatpel)) || (empty($telppel))){
		echo "Maaf, data tidak boleh kosong.";
	} elseif ($cek_noktp > 0){
		echo "noktp tidak boleh ada yang sama.";
	} else {
		$input = "insert into pelanggan values('$noktp','$namapel','$alamatpel','$telppel')";
		mysql_query($input);
		if ($input){
			echo "Data berhasil disimpan. <a href=tpelanggan.php>kembali</a>";
		} else {
