...
<?php
	include "../koneksi.php";
	$noktp = $_GET['noktp'];
	$hapus = "delete from pelanggan where noktp='$noktp'";
	$hasil = mysql_query($hapus);
	if ($hasil){
		echo "Data berhasil dihapus, <a href=tpelanggan.php>kembali</a>";
	}else{
		echo "Data gagal dihapus, <a href=tpelanggan.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
