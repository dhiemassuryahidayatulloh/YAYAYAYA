...
<div id="wrapper">
	...
	$edit = "update pelanggan set telppel='$telppel', alamatpel='$alamatpel', namapel='$namapel' where noktp='$noktp'";
	$hasil = mysql_query($edit);
	if($hasil){
		echo "Data berhasil diedit, <a href=tpelanggan.php>kembali</a>";
	} else {
		echo "Data gagal diedit. <a href=editpelanggan.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
