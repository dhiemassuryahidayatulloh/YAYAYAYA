<html>
 ...
 <table class="data">
	 ...
	 <tr class="data">
		 ...
		 <td class="data"><?php echo "$data[namapel]"; ?></td>
		 <td class="data"><?php echo "$data[alamatpel]"; ?></td>
		 <td class="data"><?php echo "$data[telppel]"; ?></td>
		 <td class="data"><a href=hapuspelanggan.php?noktp=<?php echo "$data[noktp]";?> 
		 onclick="if (!confirm('Anda yakin akan menghapus?')) return false;">
		 hapus</a></td>
		 <td class="data"><a href=editpelanggan.php?noktp=<?php echo "$data[noktp]";?>>edit</a></td>
	 </tr>
	 <?php } ?>
 </table>
 <a href="inputpelanggan.php">input</a>
	 </div>
 <div class="clear"></div>
 <div id="footer">
