...
<div id="wrapper">
	...
	<div id="rightContent">
	<h3>Input merk</h3>
	<form action="inputmerk.php" method="post">
	<table width="95%">
		<tr><td width="125px"><b>kodemerk</b></td><td><input type="text" name="kodemerk" class="pendek"></td></tr>
		<tr><td width="125px"><b>nmmerk</b></td><td><input type="text" name="nmmerk" class="sedang"></td></tr>
	</table>
	...
	$nmmerk = $_POST['nmmerk'];
	$cek_kodemerk = mysql_num_rows(mysql_query("select * from merk where kodemerk='$kodemerk'"));
	
	if((empty($kodemerk)) || (empty($nmmerk))){
		echo "Maaf, data tidak boleh kosong.";
	} elseif ($cek_kodemerk > 0){
		echo "kodemerk tidak boleh ada yang sama.";
	} else {
		$input = "insert into merk values('$kodemerk','$nmmerk')";
		mysql_query($input);
		if ($input){
			echo "Data berhasil disimpan. <a href=tmerk.php>kembali</a>";
		} else {
