...
<div id="wrapper">
	...
	$nmmerk = $_POST['nmmerk'];
	$edit = "update merk set nmmerk='$nmmerk' where kodemerk='$kodemerk' ";
	$hasil = mysql_query($edit);
	if($hasil){
		echo "Data berhasil diedit, <a href=tmerk.php>kembali</a>";
	} else {
		echo "Data gagal diedit. <a href=editmerk.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
