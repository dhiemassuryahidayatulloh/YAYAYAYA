...
<div id="wrapper">
	...
	$edit = "update kendaraan set kodepemilik='$kodepemilik', idtype='$idtype', kodeservice='$kodeservice', statusrental='$statusrental', tarifperjam='$tarifperjam', tahun='$tahun' where noplat='$noplat'";
	$hasil = mysql_query($edit);
	if($hasil){
		echo "Data berhasil diedit, <a href=tkendaraan.php>kembali</a>";
	} else {
		echo "Data gagal diedit. <a href=editkendaraan.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
