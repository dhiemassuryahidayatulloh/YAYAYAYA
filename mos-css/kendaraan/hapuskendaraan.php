...
<?php
	include "../koneksi.php";
	$noplat = $_GET['noplat'];
	$hapus = "delete from kendaraan where noplat='$noplat'";
	$hasil = mysql_query($hapus);
	if ($hasil){
		echo "Data berhasil dihapus, <a href=tkendaraan.php>kembali</a>";
	}else{
		echo "Data gagal dihapus, <a href=tkendaraan.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
