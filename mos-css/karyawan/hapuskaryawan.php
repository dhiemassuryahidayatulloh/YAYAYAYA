...
<?php
	include "../koneksi.php";
	$nik = $_GET['nik'];
	$hapus = "delete from karyawan where nik='$nik'";
	$hasil = mysql_query($hapus);
	if ($hasil){
		echo "Data berhasil dihapus, <a href=tkaryawan.php>kembali</a>";
	}else{
		echo "Data gagal dihapus, <a href=tkaryawan.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
