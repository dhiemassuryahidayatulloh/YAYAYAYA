 ...
 <table class="data">
	 ...
	 <tr class="data">
		 ...
		 <td class="data"><?php echo "$data[nmkaryawan]"; ?></td>
		 <td class="data"><?php echo "$data[almtkaryawan]"; ?></td>
		 <td class="data"><?php echo "$data[telpkaryawan]"; ?></td>
		 <td class="data"><?php echo "$data[nosetoran]"; ?></td>
		 <td class="data"><a href=hapuskaryawan.php?nik=<?php echo "$data[nik]";?> 
		 onclick="if (!confirm('Anda yakin akan menghapus?')) return false;">
		 hapus</a></td>
		 <td class="data"><a href=editkaryawan.php?nik=<?php echo "$data[nik]";?>>edit</a></td>
	 </tr>
	 <?php } ?>
 </table>
 <a href="inputkaryawan.php">input</a>
	 </div>
 <div class="clear"></div>
 <div id="footer">
