...
<div id="wrapper">
	...
	$edit = "update karyawan set nosetoran='$nosetoran', telpkaryawan='$telpkaryawan', nmkaryawan='$nmkaryawan', almtkaryawan='$almtkaryawan'  where nik='$nik'";
	$hasil = mysql_query($edit);
	if($hasil){
		echo "Data berhasil diedit, <a href=tkaryawan.php>kembali</a>";
	} else {
		echo "Data gagal diedit. <a href=editkaryawan.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
