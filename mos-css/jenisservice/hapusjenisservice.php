...
<div id="wrapper">
	...
	<div id="rightContent">
	<h3>Hapus jenisservice</h3>
<?php
	include "../koneksi.php";
	$idjenisservice = $_GET['idjenisservice'];
	$hapus = "delete from jenisservice where idjenisservice='$idjenisservice'";
	$hasil = mysql_query($hapus);
	if ($hasil){
		echo "Data berhasil dihapus, <a href=tjenisservice.php>kembali</a>";
	}else{
		echo "Data gagal dihapus, <a href=tjenisservice.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
<div id="footer">
	&copy; 2016 MOS css template | <a href="SI REMO.com">Sistem Informasi Rental Mobil</a> | design <a href="http://DHIEMAZ SURYA.com" rel="nofollow" target="_blank">DHIEMAZ SURYA.com</a><br>
