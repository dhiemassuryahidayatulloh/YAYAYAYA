...
<div id="wrapper">
	...
	<div id="rightContent">
	<h3>Edit jenisservice</h3>
	<?php
	include "../koneksi.php";
	
	$idjenisservice = $_GET['idjenisservice'];
	
	$tampil = "select * from jenisservice where idjenisservice='$idjenisservice'";
	$hasil = mysql_query($tampil);
	echo "<form action=editjenisservicedua.php method=POST>";
	echo "<table width=95% border='1'>";	
	while($data = mysql_fetch_array($hasil)){
		echo "<tr><td width=125px>idjenisservice </td>
		<td><input type=text class=pendek name=idjenisservice value='$data[idjenisservice]' readonly></td></tr>";
		echo "<tr><td>nmjenisservice </td>
		<td><input type=text class=sedang name=nmjenisservice value='$data[nmjenisservice]'></td></tr>";
	}
	echo "</table>";
