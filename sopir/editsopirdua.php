...
<div id="wrapper">
	...
	$edit = "update sopir set tarifperjam='$tarifperjam', nosim='$nosim', telpsopir='$telpsopir', almtsopir='$almtsopir', nmsopir='$nmsopir' where idsopir='$idsopir'";
	$hasil = mysql_query($edit);
	if($hasil){
		echo "Data berhasil diedit, <a href=tsopir.php>kembali</a>";
	} else {
		echo "Data gagal diedit. <a href=editsopir.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
