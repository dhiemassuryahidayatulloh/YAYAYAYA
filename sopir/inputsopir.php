...
<div id="wrapper">
	...
	<div id="rightContent">
	<h3>Input sopir</h3>
	<form action="inputsopir.php" method="post">
	<table width="95%">
		<tr><td width="125px"><b>idsopir</b></td><td><input type="text" name="idsopir" class="pendek"></td></tr>
		<tr><td width="125px"><b>nmsopir</b></td><td><input type="text" name="nmsopir" class="sedang"></td></tr>
		<tr><td width="125px"><b>almtsopir</b></td><td><input type="text" name="almtsopir" class="panjang"></td></tr>
		<tr><td width="125px"><b>telpsopir</b></td><td> <input type="text" name="telpsopir" class="sedang"></td></tr>
		<tr><td width="125px"><b>nosim</b></td><td> <input type="text" name="nosim" class="sedang"></td></tr>
		<tr><td width="125px"><b>tarifperjam</b></td><td> <input type="text" name="tarifperjam" class="sedang"></td></tr>
	</table>
	...
	$almtsopir = $_POST['almtsopir'];
	$telpsopir = $_POST['telpsopir'];
	$nosim = $_POST['nosim'];
	$tarifperjam = $_POST['tarifperjam'];
	$cek_idsopir = mysql_num_rows(mysql_query("select * from sopir where idsopir='$idsopir'"));
	
	if((empty($idsopir)) || (empty($nmsopir)) || (empty($almtsopir)) || (empty($telpsopir)) || (empty($nosim))  || (empty($tarifperjam))){
		echo "Maaf, data tidak boleh kosong.";
	} elseif ($cek_idsopir > 0){
		echo "idsopir tidak boleh ada yang sama.";
	} else {
		$input = "insert into sopir values('$idsopir','$nmsopir','$almtsopir','$telpsopir','$nosim','$tarifperjam')";
		mysql_query($input);
		if ($input){
			echo "Data berhasil disimpan. <a href=tsopir.php>kembali</a>";
		} else {
