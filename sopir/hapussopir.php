...
<?php
	...
	$hapus = "delete from sopir where idsopir='$idsopir'";
	$hasil = mysql_query($hapus);
	if ($hasil){
		echo "Data berhasil dihapus, <a href=tsopir.php>kembali</a>";
	}else{
		echo "Data gagal dihapus, <a href=tsopir.php>kembali</a>";
	}
?>
	</div>
<div class="clear"></div>
